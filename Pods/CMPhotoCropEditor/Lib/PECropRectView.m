...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView.image = [[UIImage imageNamed:[NSString stringWithFormat:@"%@/PEPhotoCropEditorBorder", [PECropViewController bundle].resourcePath]]resizableImageWithCapInsets:UIEdgeInsetsMake(23.0f, 23.0f, 23.0f, 23.0f)];
